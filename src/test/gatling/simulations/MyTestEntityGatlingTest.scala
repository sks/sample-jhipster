...
/**
 * Performance test for the MyTestEntity entity.
 */
class MyTestEntityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the MyTestEntity entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all myTestEntities")
            .get("/api/my-test-entities")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created myTestEntity")
                .get("${new_myTestEntity_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created myTestEntity")
            .delete("${new_myTestEntity_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
